...
class EnderecoDAO {
    ...
    public function RetornarTodosUsuarioCod(int $usuarioCod) {
        try {
            $sql = "SELECT e.cod, e.rua, e.numero, e.bairro, e.cidade, e.estado, e.complemento, e.cep, u.nome "
                    . "FROM endereco e INNER JOIN usuario u ON u.cod = e.usuario_cod WHERE e.usuario_cod = :usuariocod ORDER by e.cod DESC";
