                        ...
                        if ($listaUsuariosBusca != null) {
                            foreach ($listaUsuariosBusca as $user) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?pagina=endereco&cod=<?= $user->getCod(); ?>"><img src="img/icones/Address64.png" alt=""/></a>
                                        <a href="?pagina=telefone&cod=<?= $user->getCod(); ?>"><img src="img/icones/phone64.png" alt=""/></a>
                                        <a href="?pagina=alterarsenha&cod=<?= $user->getCod(); ?>"><img src="img/icones/senha.png" alt=""/></a>
                                        <a href="?pagina=visualizarusuario&cod=<?= $user->getCod(); ?>"><img src="img/icones/view.png" alt=""/></a>
